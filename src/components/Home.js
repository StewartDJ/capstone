...
<div id="carouselExampleSlidesOnly" className="carousel slide" data-ride="carousel">
  <div className="carousel-inner">
    <div className="carousel-item active">
      <img className="d-block w-100" src={require('../assets/tourist2.jpg')} alt="First slide"/>
    </div>
    <div className="carousel-item">
      <img className="d-block w-100" src={require('../assets/tourist3.jpg')} alt="Second slide"/>
    </div>
    <div className="carousel-item">
      <img className="d-block w-100"src={require('../assets/tourists4.jpg')} alt="Third slide"/>
    </div>
  </div>
</div>
</div>
